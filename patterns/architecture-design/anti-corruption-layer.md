...
Интеграция с legacy-системой или внешним сервисом приносит чужую модель в ваш домен. Если позволить чужой модели «протечь» внутрь, она исказит ваш [Ubiquitous Language](ubiquitous-language.md) и сломает инварианты.

## Решение

Anti-Corruption Layer (ACL) — изолирующий слой, который транслирует чужую модель в вашу. ACL находится на границе вашего [Bounded Context](bounded-context.md) и действует как фасад + адаптер + транслятор.
...
- Поставщик использует тот же [Ubiquitous Language](ubiquitous-language.md) (Customer–Supplier).
