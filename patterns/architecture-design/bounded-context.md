...
Явно определить границы, внутри которых конкретная модель имеет однозначный смысл. Внутри Bounded Context действует свой Ubiquitous Language, своя модель данных и свои инварианты.
