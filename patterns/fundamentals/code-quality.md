...
## Kanat-Alexander: Design for maintenance

**Code is read 10 times more often than it is written.** This means readability is the primary design constraint — not write-time convenience, not cleverness, not brevity. Every time you save 5 minutes writing clever code, you cost the team 50 minutes of reading it across its lifetime.

Consequence: simplicity is not just aesthetic — it's the single biggest factor in maintenance cost. Simple code is cheaper to read, easier to debug, and safer to modify. Naming, structure, and clarity are not cosmetic; they are the primary determinants of total cost of ownership.

See also: [Design for change](design-for-change.md), [Simplicity First](simplicity-first.md).
...
- [Design for change](design-for-change.md) — design for maintenance and readability
- [Simplicity First](simplicity-first.md) — simplicity as the fundamental design goal

## Источник

Steve McConnell, *Code Complete* (2004), Chapters 6–7, 16–17, 23–24.
Max Kanat-Alexander, *The Simple Elegance of Software Design* (2013) — "code is read 10x more than written."
